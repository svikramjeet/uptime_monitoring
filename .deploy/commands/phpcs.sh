...
./vendor/bin/phpcs . --ignore=config/*,vendor/*,resources/*,bootstrap/*,storage/*,database/*,_ide_helper* --runtime-set ignore_warnings_on_exit true --standard=./.deploy/phpcs_ruleset.xml
